...
Cùng cài đặt Reply Guys nào — chỉ mất khoảng 2 phút. 🚀

## Bước 1: Cài đặt tiện ích Chrome

Reply Guys là tiện ích cho Chrome / Edge, bổ sung một bảng điều khiển (side panel) vào **X (Twitter)**, **Farcaster**, và **Binance Square**.
...
Sau đó mở bảng điều khiển bằng cách **nhấp vào tab Reply Guys** — biểu tượng sparkle nhỏ được ghim ở **cạnh phải của trang**:

![Tab Reply Guys nằm ở cạnh phải của trang — nhấp vào để mở bảng điều khiển](/docs/images/side-panel-launcher.svg)

**Bảng điều khiển** sẽ trượt ra ở bên phải và tự động hiển thị đúng giao diện cho trang bạn đang xem — bảng X trên X, bảng Farcaster trên Farcaster, và bảng Binance Square trên Binance Square. (Tab đổi màu theo từng trang — đen trên X, tím brand ở các trang khác — nhưng luôn là cùng một biểu tượng sparkle.)

> **Thích dùng thanh công cụ?** Nhấp **biểu tượng Reply Guys** trên thanh công cụ cũng được. Nếu bạn nhấp nó khi đang ở trang khác, Reply Guys sẽ nhắc nhẹ bạn mở X, Farcaster, hoặc Binance Square trước.
...
- **Continue with Discord** — mở trang cấp quyền của Discord. Chấp thuận quyền truy cập, và bạn được đăng nhập tự động.

Bạn cứ để bảng điều khiển mở trong khi hoàn tất đăng nhập ở tab kia — nó sẽ tự hoàn thành. (Một phiên đăng nhập đang chờ sẽ hết hạn sau khoảng 30 phút; nếu hết giờ, chỉ cần nhấp lại nút.)
...
- ✅ Tài khoản X (Twitter), Farcaster, và/hoặc Binance Square
...
- Đảm bảo bạn đang ở **x.com**, **twitter.com**, **farcaster.xyz**, hoặc **binance.com/square**
- Làm mới trang, rồi nhấp lại tab ở cạnh trang (hoặc biểu tượng trên thanh công cụ)
